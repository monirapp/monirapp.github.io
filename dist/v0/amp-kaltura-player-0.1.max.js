(self.AMP=self.AMP||[]).push({n:"amp-kaltura-player",v:"1537224222059",f:(function(AMP,_){
...
var AmpKaltura = function (_AMP$BaseElement) {
  _inherits(AmpKaltura, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpKaltura(element) {
    _classCallCheck(this, AmpKaltura);

    /** @private {?HTMLIFrameElement} */
    var _this = _possibleConstructorReturn(this, (AmpKaltura.__proto__ || Object.getPrototypeOf(AmpKaltura)).call(this, element));
  ...
  */
  ...
  _createClass(AmpKaltura, [{
    ...
    value: function buildCallback() {
      this.partnerId_ = (0, _log.user)().assert(this.element.getAttribute('data-partner'), 'The data-partner attribute is required for <amp-kaltura-player> %s', this.element);
    ...
    value: function layoutCallback() {
      ...
      var params = (0, _dom.getDataParamsFromAttributes)(this.element, function (key) {
...
AMP.extension('amp-kaltura-player', '0.1', function (AMP) {
