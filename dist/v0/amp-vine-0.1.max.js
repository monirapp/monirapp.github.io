(self.AMP=self.AMP||[]).push({n:"amp-vine",v:"1537224222059",f:(function(AMP,_){
...
var AmpVine = function (_AMP$BaseElement) {
  _inherits(AmpVine, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpVine(element) {
    _classCallCheck(this, AmpVine);

    /** @private {?Element} */
    var _this = _possibleConstructorReturn(this, (AmpVine.__proto__ || Object.getPrototypeOf(AmpVine)).call(this, element));
  ...
  _createClass(AmpVine, [{
    ...
    value: function layoutCallback() {
      var vineid = (0, _log.user)().assert(this.element.getAttribute('data-vineid'), 'The data-vineid attribute is required for <amp-vine> %s', this.element);
...
AMP.extension('amp-vine', '0.1', function (AMP) {
