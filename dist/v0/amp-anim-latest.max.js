(self.AMP=self.AMP||[]).push({n:"amp-anim",v:"1537222846916",f:(function(AMP,_){
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.AmpAnim = exports.SRC_PLACEHOLDER = undefined;
...
/** @visibleForTesting */
var SRC_PLACEHOLDER = exports.SRC_PLACEHOLDER = 'data:image/gif;base64,' + 'R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7';

var AmpAnim = exports.AmpAnim = function (_AMP$BaseElement) {
  _inherits(AmpAnim, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpAnim(element) {
    _classCallCheck(this, AmpAnim);

    /** @private {?Element} */
    var _this = _possibleConstructorReturn(this, (AmpAnim.__proto__ || Object.getPrototypeOf(AmpAnim)).call(this, element));

    _this.img_ = null;

    /** @private {boolean} */
    _this.hasLoaded_ = false;
    return _this;
  }
  ...
  _createClass(AmpAnim, [{
    ...
    value: function buildCallback() {
      ...
      st.toggle((0, _log.dev)().assertElement(this.img_), !this.getPlaceholder());
    ...
    value: function layoutCallback() {
      ...
      (0, _img.guaranteeSrcForSrcsetUnsupportedBrowsers)(img);
    ...
    value: function updateInViewport_() {
      var inViewport = this.isInViewport();
      this.togglePlaceholder(!inViewport);
      st.toggle((0, _log.dev)().assertElement(this.img_), inViewport);
    }
  }]);
...
},{"../../../src/layout":2,"../../../src/log":3,"../../../src/style":8,"../../../src/utils/img":12}],2:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./log":3,"./utils/object.js":13}],7:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./string":7,"./utils/object.js":13}],9:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
