(self.AMP=self.AMP||[]).push({n:"amp-reach-player",v:"1537224222059",f:(function(AMP,_){
...
var AmpReachPlayer = function (_AMP$BaseElement) {
  _inherits(AmpReachPlayer, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpReachPlayer(element) {
    _classCallCheck(this, AmpReachPlayer);

    /** @private {?Element} */
    var _this = _possibleConstructorReturn(this, (AmpReachPlayer.__proto__ || Object.getPrototypeOf(AmpReachPlayer)).call(this, element));
...
AMP.extension('amp-reach-player', '0.1', function (AMP) {
