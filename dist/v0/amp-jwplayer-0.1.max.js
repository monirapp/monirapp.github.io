(self.AMP=self.AMP||[]).push({n:"amp-jwplayer",v:"1537222846916",f:(function(AMP,_){
...
var AmpJWPlayer = function (_AMP$BaseElement) {
  _inherits(AmpJWPlayer, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpJWPlayer(element) {
    _classCallCheck(this, AmpJWPlayer);

    /** @private {string} */
    var _this = _possibleConstructorReturn(this, (AmpJWPlayer.__proto__ || Object.getPrototypeOf(AmpJWPlayer)).call(this, element));
  ...
  _createClass(AmpJWPlayer, [{
    ...
    value: function buildCallback() {
      this.contentid_ = (0, _log.user)().assert(this.element.getAttribute('data-playlist-id') || this.element.getAttribute('data-media-id'), 'Either the data-media-id or the data-playlist-id ' + 'attributes must be specified for <amp-jwplayer> %s', this.element);

      this.playerid_ = (0, _log.user)().assert(this.element.getAttribute('data-player-id'), 'The data-player-id attribute is required for <amp-jwplayer> %s', this.element);
    }
...
AMP.extension('amp-jwplayer', '0.1', function (AMP) {
...
},{"../third_party/css-escape/css-escape":15,"./log":4,"./string":8,"./types":10,"./utils/object":13,"./utils/promise":14}],3:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
