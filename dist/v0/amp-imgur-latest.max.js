(self.AMP=self.AMP||[]).push({n:"amp-imgur",v:"1537224222059",f:(function(AMP,_){
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.AmpImgur = undefined;
...
var AmpImgur = exports.AmpImgur = function (_AMP$BaseElement) {
  _inherits(AmpImgur, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpImgur(element) {
    _classCallCheck(this, AmpImgur);

    /** @private {?Element} */
    var _this = _possibleConstructorReturn(this, (AmpImgur.__proto__ || Object.getPrototypeOf(AmpImgur)).call(this, element));
  ...
  _createClass(AmpImgur, [{
    ...
    value: function buildCallback() {
      this.imgurid_ = (0, _log.user)().assert(this.element.getAttribute('data-imgur-id'), 'The data-imgur-id attribute is required for <amp-imgur> %s', this.element);
    }
    ...
    value: function layoutCallback() {
      ...
      this.unlistenMessage_ = (0, _eventHelper.listen)(this.win, 'message', this.handleImgurMessages_.bind(this));

      iframe.setAttribute('scrolling', 'no');
      iframe.setAttribute('frameborder', '0');
      iframe.setAttribute('allowfullscreen', 'true');

      iframe.src = 'https://imgur.com/' + encodeURIComponent(this.imgurid_) + '/embed?pub=true';
    ...
    key: 'handleImgurMessages_',
    value: function handleImgurMessages_(event) {
...
AMP.extension('amp-imgur', '0.1', function (AMP) {
  AMP.registerElement('amp-imgur', AmpImgur);
});

},{"../../../src/dom":2,"../../../src/event-helper":4,"../../../src/json":5,"../../../src/layout":6,"../../../src/log":7,"../../../src/string":11,"../../../src/types":13}],2:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"../third_party/css-escape/css-escape":18,"./log":7,"./string":11,"./types":13,"./utils/object":16,"./utils/promise":17}],3:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./types":13}],6:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"../types":13}],17:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
