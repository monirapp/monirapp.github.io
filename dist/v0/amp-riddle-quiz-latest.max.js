(self.AMP=self.AMP||[]).push({n:"amp-riddle-quiz",v:"1537222846916",f:(function(AMP,_){
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.AmpRiddleQuiz = undefined;
...
var AmpRiddleQuiz = exports.AmpRiddleQuiz = function (_AMP$BaseElement) {
  _inherits(AmpRiddleQuiz, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpRiddleQuiz(element) {
    _classCallCheck(this, AmpRiddleQuiz);

    /** @private {?Element} */
    var _this = _possibleConstructorReturn(this, (AmpRiddleQuiz.__proto__ || Object.getPrototypeOf(AmpRiddleQuiz)).call(this, element));

    _this.iframe_ = null;

    /** @private {?number} */
    _this.itemHeight_ = 400; //default

    /** @private {?number} */
    _this.riddleId_ = null;
  ...
  _createClass(AmpRiddleQuiz, [{
    ...
    value: function layoutCallback() {
      this.riddleId_ = (0, _log.user)().assert(this.element.getAttribute('data-riddle-id'), 'The data-riddle-id attribute is required for <amp-riddle-quiz> %s', this.element);
      // listen for resize events coming from riddles
      this.unlistenMessage_ = (0, _eventHelper.listen)(this.win, 'message', this.handleMessage_.bind(this));
    ...
    value: function riddleHeightChanged_(height) {
      if (!(0, _types.isFiniteNumber)(height) || height === this.itemHeight_) {
        return;
      }
  ...
  return AmpRiddleQuiz;
}(AMP.BaseElement);

AMP.extension('amp-riddle-quiz', '0.1', function (AMP) {
  AMP.registerElement('amp-riddle-quiz', AmpRiddleQuiz, false);
});

},{"../../../src/dom":2,"../../../src/layout":5,"../../../src/log":6,"../../../src/types":12,"./../../../src/event-helper":4}],2:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"../third_party/css-escape/css-escape":17,"./log":6,"./string":10,"./types":12,"./utils/object":15,"./utils/promise":16}],3:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./log":6,"./utils/object.js":15}],10:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./string":10,"./utils/object.js":15}],12:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"../types":12}],16:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
