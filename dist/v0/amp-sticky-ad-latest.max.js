...
var AmpStickyAd = function (_AMP$BaseElement) {
  _inherits(AmpStickyAd, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpStickyAd(element) {
    _classCallCheck(this, AmpStickyAd);

    /** @const @private {!../../../src/service/vsync-impl.Vsync} */
    var _this = _possibleConstructorReturn(this, (AmpStickyAd.__proto__ || Object.getPrototypeOf(AmpStickyAd)).call(this, element));
  ...
  _createClass(AmpStickyAd, [{
    ...
    value: function buildCallback() {
      ...
      (0, _log.user)().assert(children.length == 1 && children[0].tagName == 'AMP-AD', 'amp-sticky-ad must have a single amp-ad child');

      this.ad_ = children[0];
      this.setAsOwner(this.ad_);

      this.adReadyPromise_ = (0, _dom.whenUpgradedToCustomElement)((0, _log.dev)().assertElement(this.ad_)).then(function (ad) {
        return ad.whenBuilt();
      }).then(function () {
        return _this2.mutateElement(function () {
          (0, _style.toggle)(_this2.element, true);
        });
      });
    ...
    value: function layoutCallback() {
      ...
      if (this.visible_) {
        ...
        this.updateInViewport((0, _log.dev)().assertElement(this.ad_), true);
        this.scheduleLayout((0, _log.dev)().assertElement(this.ad_));
      }
    ...
    value: function collapsedCallback() {
      var _this3 = this;
    ...
    key: 'removeOnScrollListener_',
    value: function removeOnScrollListener_() {
    ...
    value: function display_() {
      ...
      this.adReadyPromise_.then(function () {
        ...
        _this4.mutateElement(function () {
          ...
          _this4.viewport_.addToFixedLayer(_this4.element, /* forceTransfer */true).then(function () {
    ...
    key: 'scheduleLayoutForAd_',
    value: function scheduleLayoutForAd_() {
      var _this5 = this;

      (0, _dom.whenUpgradedToCustomElement)((0, _log.dev)().assertElement(this.ad_)).then(function (ad) {
        ad.whenBuilt().then(_this5.layoutAd_.bind(_this5));
      });
    }
    ...
    key: 'layoutAd_',
    value: function layoutAd_() {
      var _this6 = this;

      var ad = (0, _log.dev)().assertElement(this.ad_);
      ...
      return Promise.race([signals.whenSignal(_commonSignals.CommonSignals.RENDER_START), signals.whenSignal(_commonSignals.CommonSignals.LOAD_END)]).then(function () {
        var backgroundColor = void 0;
        return _this6.measureElement(function () {
          backgroundColor = (0, _style.computedStyle)(_this6.win, _this6.element)['backgroundColor'];
        }).then(function () {
          return _this6.vsync_.mutatePromise(function () {
            ...
            var borderBottom = _this6.element. /*OK*/offsetHeight;
    ...
    value: function onCloseButtonClick_() {
      ...
      this.vsync_.mutate(function () {
        ...
        _this7. /*OK*/scheduleUnlayout((0, _log.dev)().assertElement(_this7.ad_));
        _this7.viewport_.removeFromFixedLayer(_this7.element);
        (0, _dom.removeElement)(_this7.element);
    ...
    key: 'forceOpacity_',
    value: function forceOpacity_(backgroundColor) {
      var newBackgroundColor = (0, _style.removeAlphaFromColor)(backgroundColor);
      if (backgroundColor == newBackgroundColor) {
        return;
      }
      (0, _log.user)().warn('AMP-STICKY-AD', 'Do not allow container to be semitransparent');
      (0, _style.setStyle)(this.element, 'background-color', newBackgroundColor);
    }
  }]);
...
AMP.extension('amp-sticky-ad', '1.0', function (AMP) {
  AMP.registerElement('amp-sticky-ad', AmpStickyAd, _ampStickyAd.CSS);
});

},{"../../../build/amp-sticky-ad-1.0.css":1,"../../../src/common-signals":3,"../../../src/dom":4,"../../../src/log":5,"../../../src/style":9}],3:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
/**
...
},{"../third_party/css-escape/css-escape":15,"./log":5,"./string":8,"./types":10,"./utils/object":13,"./utils/promise":14}],5:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./url-parse-query-string":11}],8:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
},{"./url-try-decode-uri-component":12}],12:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
