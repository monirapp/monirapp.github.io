(self.AMP=self.AMP||[]).push({n:"amp-hulu",v:"1537222846916",f:(function(AMP,_){
...
var AmpHulu = function (_AMP$BaseElement) {
  _inherits(AmpHulu, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpHulu(element) {
    _classCallCheck(this, AmpHulu);

    /** @private {?Element} */
    var _this = _possibleConstructorReturn(this, (AmpHulu.__proto__ || Object.getPrototypeOf(AmpHulu)).call(this, element));
  ...
  _createClass(AmpHulu, [{
    ...
    value: function buildCallback() {
      this.eid_ = (0, _log.user)().assert(this.element.getAttribute('data-eid'), 'The data-eid attribute is required for <amp-hulu> %s', this.element);
    }
...
AMP.extension('amp-hulu', '0.1', function (AMP) {
