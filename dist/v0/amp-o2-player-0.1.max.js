(self.AMP=self.AMP||[]).push({n:"amp-o2-player",v:"1537222846916",f:(function(AMP,_){
...
var AmpO2Player = function (_AMP$BaseElement) {
  _inherits(AmpO2Player, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpO2Player(element) {
    _classCallCheck(this, AmpO2Player);

    /** @private {?HTMLIFrameElement} */
    var _this = _possibleConstructorReturn(this, (AmpO2Player.__proto__ || Object.getPrototypeOf(AmpO2Player)).call(this, element));
  ...
  _createClass(AmpO2Player, [{
    ...
    value: function buildCallback() {
      this.pid_ = (0, _log.user)().assert(this.element.getAttribute('data-pid'), 'data-pid attribute is required for <amp-o2-player> %s', this.element);

      this.bcid_ = (0, _log.user)().assert(this.element.getAttribute('data-bcid'), 'data-bcid attribute is required for <amp-o2-player> %s', this.element);
    ...
    value: function layoutCallback() {
      (0, _log.user)().assert(this.pid_, 'data-pid attribute is required for <amp-o2-player> %s', this.element);
      (0, _log.user)().assert(this.bcid_, 'data-bcid attribute is required for <amp-o2-player> %s', this.element);
...
AMP.extension('amp-o2-player', '0.1', function (AMP) {
  AMP.registerElement('amp-o2-player', AmpO2Player);
});

},{"../../../src/layout":2,"../../../src/log":3,"../../../src/utils/object":12}],2:[function(require,module,exports){
