(self.AMP=self.AMP||[]).push({n:"amp-soundcloud",v:"1537222846916",f:(function(AMP,_){
...
var AmpSoundcloud = function (_AMP$BaseElement) {
  _inherits(AmpSoundcloud, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpSoundcloud(element) {
    _classCallCheck(this, AmpSoundcloud);

    /** @private {?Element} */
    var _this = _possibleConstructorReturn(this, (AmpSoundcloud.__proto__ || Object.getPrototypeOf(AmpSoundcloud)).call(this, element));
  ...
  */
  ...
  _createClass(AmpSoundcloud, [{
    ...
    value: function layoutCallback() {
      ...
      var url = 'https://api.soundcloud.com/' + (this.element.hasAttribute('data-trackid') ? 'tracks' : 'playlists') + '/';
      var mediaid = (0, _log.user)().assert(this.element.getAttribute('data-trackid') || this.element.getAttribute('data-playlistid'), 'data-trackid or data-playlistid is required for <amp-soundcloud> %s', this.element);
      ...
      var src = 'https://w.soundcloud.com/player/?' + 'url=' + encodeURIComponent(url + mediaid);
      if (secret) {
    ...
    value: function pauseCallback() {
      if (this.iframe_ && this.iframe_.contentWindow) {
        this.iframe_.contentWindow. /*OK*/postMessage(JSON.stringify((0, _object.dict)({ 'method': 'pause' })), 'https://w.soundcloud.com');
      }
    }
  }]);
...
AMP.extension('amp-soundcloud', '0.1', function (AMP) {
