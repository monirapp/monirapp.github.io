(self.AMP=self.AMP||[]).push({n:"amp-springboard-player",v:"1537224222059",f:(function(AMP,_){
...
var AmpSpringboardPlayer = function (_AMP$BaseElement) {
  _inherits(AmpSpringboardPlayer, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpSpringboardPlayer(element) {
    _classCallCheck(this, AmpSpringboardPlayer);

    /** @private {string} */
    var _this = _possibleConstructorReturn(this, (AmpSpringboardPlayer.__proto__ || Object.getPrototypeOf(AmpSpringboardPlayer)).call(this, element));
  ...
  */
  ...
  _createClass(AmpSpringboardPlayer, [{
    ...
    value: function buildCallback() {
      this.mode_ = (0, _log.user)().assert(this.element.getAttribute('data-mode'), 'The data-mode attribute is required for <amp-springboard-player> %s', this.element);
      this.contentId_ = (0, _log.user)().assert(this.element.getAttribute('data-content-id'), 'The data-content-id attribute is required for' + '<amp-springboard-player> %s', this.element);
      this.domain_ = (0, _log.user)().assert(this.element.getAttribute('data-domain'), 'The data-domain attribute is required for <amp-springboard-player> %s', this.element);
      this.siteId_ = (0, _log.user)().assert(this.element.getAttribute('data-site-id'), 'The data-site-id attribute is required for' + '<amp-springboard-player> %s', this.element);
      this.playerId_ = (0, _log.user)().assert(this.element.getAttribute('data-player-id'), 'The data-player-id attribute is required for' + '<amp-springboard-player> %s', this.element);
    }
    ...
    value: function layoutCallback() {
      ...
      iframe.src = 'https://cms.springboardplatform.com/embed_iframe/' + encodeURIComponent(this.siteId_) + '/' + encodeURIComponent(this.mode_) + '/' + encodeURIComponent(this.contentId_) + '/' + encodeURIComponent(this.playerId_) + '/' + encodeURIComponent(this.domain_) + '/' + encodeURIComponent(items);
    ...
    value: function createPlaceholderCallback() {
      ...
      if (placeholder.hasAttribute('aria-label')) {
        placeholder.setAttribute('alt', 'Loading video - ' + placeholder.getAttribute('aria-label'));
      } else {
...
AMP.extension('amp-springboard-player', '0.1', function (AMP) {
