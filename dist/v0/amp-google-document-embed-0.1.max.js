(self.AMP=self.AMP||[]).push({n:"amp-google-document-embed",v:"1537222846916",f:(function(AMP,_){
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.AmpDriveViewer = exports.TAG = undefined;
...
var TAG = exports.TAG = 'amp-google-document-embed';

var ATTRIBUTES_TO_PROPAGATE = ['title'];

var GOOGLE_DOCS_EMBED_RE = /^https?:\/\/docs\.google\.com.+\/pub.*\??/;

var AmpDriveViewer = exports.AmpDriveViewer = function (_AMP$BaseElement) {
  _inherits(AmpDriveViewer, _AMP$BaseElement);

  /** @param {!AmpElement} element */
  function AmpDriveViewer(element) {
    _classCallCheck(this, AmpDriveViewer);

    /** @private {?Element} */
    var _this = _possibleConstructorReturn(this, (AmpDriveViewer.__proto__ || Object.getPrototypeOf(AmpDriveViewer)).call(this, element));
  ...
  _createClass(AmpDriveViewer, [{
    ...
    value: function buildCallback() {
      (0, _log.user)().assert(this.element.getAttribute('src'), 'The src attribute is required for <amp-google-document-embed> %s', this.element);
    }
...
},{"../../../src/dom":3,"../../../src/layout":4,"../../../src/log":5,"../../../src/url":14}],2:[function(require,module,exports){
Object.defineProperty(exports, "__esModule", {
  value: true
});
/**
